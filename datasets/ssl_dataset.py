...
class SSL_Dataset:
    ...
    def get_data(self, svhn_extra=True, train=True):
        """
        ...
        if 'CIFAR' in self.name.upper():
            if train:
                ...
                # return data, targets,dset
                train_dataset, val_dataset, test_dataset, num_classes, num_training_samples = input_dataset(self.args.dataset, self.args.noise_type, self.args.noise_path, is_human = True, val_ratio = self.args.val_ratio)
                return train_dataset.train_data, train_dataset.train_noisy_labels,train_dataset
            else:
                pass
    ...
    def get_dset(self):
        ...
        #     data, targets, _ = self.get_data(train=False)
        # else:
        #     data, targets = self.get_data(train=False)
